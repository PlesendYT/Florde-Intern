...
// 1. layout-manager must not relocate live DOM into dockview panels at all
//    (api.clear()/fromJSON() destroy moved nodes; previously also crashed on
//    non-existent `panel.element`). Static layout stays authoritative.
